<template>
    <div class="userSettings">
            ...
            <div class="searchCondition">
                <div class="searchItem">
                    ...
                    <div class="searchInput">
                        <el-input v-model="searchCondition.loginName" placeholder="请输入账号" size="small"></el-input>
                    </div>
                </div>
                <div class="searchItem">
                    <span class="text">真实姓名</span>
                    <div class="searchInput">
                        <el-input v-model="searchCondition.realName" placeholder="请输入真实姓名" size="small"></el-input>
                    </div>
                </div>
                <!-- <div class="searchItem">
                    <span class="text">昵称</span>
                    <div class="searchInput">
                        <el-input v-model="searchCondition.nickName" placeholder="请输入昵称" size="small"></el-input>
                    </div>
                </div> -->
                <div class="searchItem">
                    <span class="text">角色</span>
                    <div class="searchInput">
                         <el-select v-model="searchCondition.Character" placeholder="请选择" clearable>
                            <el-option
                ...
                <div class="inner">
                        ...
                        <!-- <div class="orderName orderModityPublic">
                            <el-form-item label="昵称" prop="nickName">
                                    <div class="orderInput" >
                                        <el-input type="text" v-model="addData.nickName" auto-complete="off"></el-input>
                                    </div>
                                </el-form-item>
                        </div> -->
                        <div class="orderName orderModityPublic">
                        ...
                        <div class="orderName orderModityPublic">
                            <el-form-item label="接待量" prop="maxVisitors">
                                    <div class="orderInput" >
                                        <el-input type="text" v-model="addData.maxVisitors" auto-complete="off"></el-input>
                                    </div>
                                </el-form-item>
                        </div>
                        <div class="orderName orderModityPublic">
        ...
        <div class="editMask" v-if="editFlag">
            <div class="boom">
                <div class="top"><span class="delete">信息</span><a href="javascript:;" class="close"><span @click="resetForm('editData')">×</span></a>
                </div>
                <div class="inner">
        ...
        <div class="deleteMask" v-show="isDelete">
            <div class="boom">
                <div class="top"><span class="delete">删除</span><a href="javascript:;" class="close"><span @click="returnDelete">×</span></a></div>
        ...
        <div class="passWordMask" v-if="changePassWord">
            <div class="boom">
                ...
                <div class="inner">
                    <el-form :model="editData" :rules="changePassWordRules" ref="editData" label-width="120px" class="demo-ruleForm">
                        <div class="orderName orderModityPublic">
                            <el-form-item label="新密码" prop="pass">
                                    <div class="orderInput" >
  ...
  data() {
          ...
          isDelete:false,
            addRules: {
                ...
                realName:[
                    ...
                    {min: 1, max: 6, message: '真实姓名长度为6个字符', trigger: 'blur change'},
            ...
            changePassWordRules: {
                pass: [
                    ...
                    { validator: validatePassChange, trigger: 'blur change' },
                ],
                checkPass: [
    ...
    mounted () {
        ...
        var url = this.basicUrl+`/admin/package/find`;
         ...
         this.getTableListAll(this.basicUrl+`/api/auth/user/paginate?realName=&nickName=&loginName=&roleId=&status=&pageSize=10&currentPage=1&orderColumn=&dir=`);
    },
    methods: {
        ...
        searchList () {
            ...
            this.getTableListAll(this.basicUrl+`/api/auth/user/paginate?realName=${this.searchCondition.realName}&nickName=${this.searchCondition.nickName}&loginName=${this.searchCondition.loginName}&roleId=${this.searchCondition.Character}&status=${this.searchCondition.status}&pageSize=10&currentPage=1&orderColumn=&dir=`)
        },
        submitForm (formName) {
